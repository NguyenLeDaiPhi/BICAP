...
CREATE TABLE `roles` (
  ...
  `name` enum('ROLE_ADMIN','ROLE_DELIVERYDRIVER','ROLE_FARMMANAGER','ROLE_GUEST','ROLE_RETAILER','ROLE_SHIPPINGMANAGER') DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `roles` VALUES (1,'ROLE_ADMIN'),(2,'ROLE_FARMMANAGER'),(3,'ROLE_RETAILER'),(4,'ROLE_SHIPPINGMANAGER'),(5,'ROLE_DELIVERYDRIVER'),(6,'ROLE_GUEST');
...
-- Dump completed on 2026-01-19 13:42:09
...
DROP TABLE IF EXISTS `user_business_licenses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_business_licenses` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKoern9cqjgcu95v8by9gmci6tq` (`user_profile_id`),
  CONSTRAINT `FKoern9cqjgcu95v8by9gmci6tq` FOREIGN KEY (`user_profile_id`) REFERENCES `user_profiles` (`id`)
...
LOCK TABLES `user_business_licenses` WRITE;
/*!40000 ALTER TABLE `user_business_licenses` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_business_licenses` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
